...
# Save the model.
with open('cnn_lstm_qint16_not_solid.tflite', 'wb') as f:
  f.write(tflite_model)

print("test_data.shape : ",test_data.shape)
print("data_lstm_test.shape : ",data_lstm_test.shape)
...
interpret_tflite('cnn_lstm_qint16_not_solid.tflite')
interpret_tflite_by_sample('cnn_lstm_qint16_not_solid.tflite')